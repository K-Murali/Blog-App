     ...
     {(alert && <Alert message="This is deleted" />)} 
      ...
      <div className="  items-center justify-center  h-dvh flex flex-col   ">
        ...
        <form className="mb-2.5  w-4/6 container  flex flex-col items-center justify-center " action="">
          ...
          <input minLength={3} required={true}  name='title' onChange={onchange} type="text" placeholder="Enter your Title" className=" border-b-2 p-2 rounded   focus:outline-none border-gray-500  w-full" />
          ...
          <textarea  minLength={5} required={true} name='description' rows='5' onChange={onchange} type="text" placeholder=" Enter the content" className="border-b-2 p-2  rounded    focus:outline-none border-gray-500  h-9/12 w-full" />

          <label className="form-control   w-full"> <span className="label-text flex flex-col ">  <h1 className="  text-lg m-2 ">Tag</h1></span></label>
          <input name='tag' onChange={onchange} type="text" placeholder="Keep some Tag" className=" border-b-2 p-2 rounded   focus:outline-none border-gray-500 mb-5 w-full" />
